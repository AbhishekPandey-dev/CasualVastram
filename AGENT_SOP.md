...
\`\`\`bash
\# OpenCode / OpenCLI (this agent):
test \-d "$HOME/.config/opencode/skills" && echo "✅ Skills ready at $HOME/.config/opencode/skills"

\# Skills are installed at: C:\Users\X\.config\opencode\skills\
\# 1,801 total (332 ECC core + 1,469 Antigravity)
\# Skill file paths are listed in § Skill File Path Reference
...
## 🔗 SKILL FILE PATH REFERENCE — OpenCode / OpenCLI Agent {#skill-paths}

> This section maps every `@skill-name` in this document to its actual file path on disk.
> Use these paths to `read` the SKILL.md directly when the `skill` tool cannot load it.
> Base path: `C:\Users\X\.config\opencode\skills\`

### 📖 How To Use
- **🔵 Loadable via `skill` tool** — invoke directly with `skill "<name>"`
- **📄 File-only** — must be read via `read "skills/<name>/SKILL.md"` (all others)
- **📁 Subfolder** — stored under a parent category directory
- **❌ Missing** — not available; substitutes listed
...
|---|---|---|
| `@concise-planning` | `skills/concise-planning/SKILL.md` | 📄 File-only |
| `@lint-and-validate` | `skills/lint-and-validate/SKILL.md` | 📄 File-only |
| `@git-pushing` | `skills/git-pushing/SKILL.md` | 📄 File-only |
| `@kaizen` | `skills/kaizen/SKILL.md` | 📄 File-only |
| `@systematic-debugging` | `skills/systematic-debugging/SKILL.md` | 📄 File-only |

### 🖌️ Web Design Pack
| Invocation | Path | Status |
|---|---|---|
| `@ui-ux-pro-max` | `skills/ui-ux-pro-max/SKILL.md` | 🔵 Loadable |
| `@frontend-design` | `skills/frontend-design/SKILL.md` | 📄 File-only |
| `@3d-web-experience` | `skills/3d-web-experience/SKILL.md` | 📄 File-only |
| `@canvas-design` | `skills/canvas-design/SKILL.md` | 📄 File-only |
| `@mobile-design` | `skills/mobile-design/SKILL.md` | 📄 File-only |
| `@scroll-experience` | `skills/scroll-experience/SKILL.md` | 📄 File-only |

### 🌐 Web Wizard Pack
| Invocation | Path | Status |
|---|---|---|
| `@frontend-design` | `skills/frontend-design/SKILL.md` | 📄 File-only |
| `@react-best-practices` | `skills/react-best-practices/SKILL.md` | 📄 File-only |
| `@react-patterns` | `skills/react-patterns/SKILL.md` | 📄 File-only |
| `@nextjs-best-practices` | `skills/nextjs-best-practices/SKILL.md` | 📄 File-only |
| `@tailwind-patterns` | `skills/tailwind-patterns/SKILL.md` | 📄 File-only |
| `@form-cro` | `skills/form-cro/SKILL.md` | 📄 File-only |
| `@seo-audit` | `skills/seo-audit/SKILL.md` | 📄 File-only |

### ⚡ Full-Stack Developer Pack
| Invocation | Path | Status |
|---|---|---|
| `@senior-fullstack` | `skills/senior-fullstack/SKILL.md` | 📄 File-only |
| `@frontend-developer` | `skills/frontend-developer/SKILL.md` | 📄 File-only |
| `@backend-dev-guidelines` | `skills/backend-dev-guidelines/SKILL.md` | 📄 File-only |
| `@api-patterns` | `skills/api-patterns/SKILL.md` | 📄 File-only |
| `@database-design` | `skills/database-design/SKILL.md` | 📄 File-only |
| `@stripe-integration` | `skills/stripe-integration/SKILL.md` | 📄 File-only |

### 🤖 Agent Architect Pack
| Invocation | Path | Status |
|---|---|---|
| `@agent-evaluation` | `skills/agent-evaluation/SKILL.md` | 📄 File-only |
| `@langgraph` | `skills/langgraph/SKILL.md` | 📄 File-only |
| `@mcp-builder` | `skills/mcp-builder/SKILL.md` | 📄 File-only |
| `@prompt-engineering` | `skills/prompt-engineering/SKILL.md` | 📄 File-only |
| `@ai-agents-architect` | `skills/ai-agents-architect/SKILL.md` | 📄 File-only |
| `@rag-engineer` | `skills/rag-engineer/SKILL.md` | 📄 File-only |

### 🧠 LLM Application Developer Pack
| Invocation | Path | Status |
|---|---|---|
| `@llm-app-patterns` | `skills/llm-app-patterns/SKILL.md` | 📄 File-only |
| `@rag-implementation` | `skills/rag-implementation/SKILL.md` | 📄 File-only |
| `@prompt-caching` | `skills/prompt-caching/SKILL.md` | 📄 File-only |
| `@context-window-management` | `skills/context-window-management/SKILL.md` | 📄 File-only |
| `@langfuse` | `skills/langfuse/SKILL.md` | 📄 File-only |

### 🐍 Python Pro Pack
| Invocation | Path | Status |
|---|---|---|
| `@python-pro` | `skills/python-pro/SKILL.md` | 📄 File-only |
| `@python-patterns` | `skills/python-patterns/SKILL.md` | 🔵 Loadable |
| `@fastapi-pro` | `skills/fastapi-pro/SKILL.md` | 📄 File-only |
| `@fastapi-templates` | `skills/fastapi-templates/SKILL.md` | 📄 File-only |
| `@async-python-patterns` | `skills/async-python-patterns/SKILL.md` | 📄 File-only |
| `@python-testing-patterns` | `skills/python-testing-patterns/SKILL.md` | 📄 File-only |

### 🟦 TypeScript & JavaScript Pack
| Invocation | Path | Status |
|---|---|---|
| `@typescript-expert` | `skills/typescript-expert/SKILL.md` | 📄 File-only |
| `@javascript-pro` | `skills/javascript-pro/SKILL.md` | 📄 File-only |
| `@react-best-practices` | `skills/react-best-practices/SKILL.md` | 📄 File-only |
| `@nodejs-best-practices` | `skills/nodejs-best-practices/SKILL.md` | 📄 File-only |
| `@nextjs-app-router-patterns` | `skills/nextjs-app-router-patterns/SKILL.md` | 📄 File-only |

### 🛡️ Security Engineer Pack
| Invocation | Path | Status |
|---|---|---|
| `@ethical-hacking-methodology` | `skills/ethical-hacking-methodology/SKILL.md` | 📄 File-only |
| `@top-web-vulnerabilities` | `skills/top-web-vulnerabilities/SKILL.md` | 📄 File-only |
| `@security-auditor` | `skills/security-auditor/SKILL.md` | 📄 File-only |
| `@vulnerability-scanner` | `skills/vulnerability-scanner/SKILL.md` | 📄 File-only |
| `@cloud-penetration-testing` | `skills/cloud-penetration-testing/SKILL.md` | 📄 File-only |

### 🔐 Security Developer Pack
| Invocation | Path | Status |
|---|---|---|
| `@api-security-best-practices` | `skills/api-security-best-practices/SKILL.md` | 📄 File-only |
| `@auth-implementation-patterns` | `skills/auth-implementation-patterns/SKILL.md` | 📄 File-only |
| `@backend-security-coder` | `skills/backend-security-coder/SKILL.md` | 📄 File-only |
| `@frontend-security-coder` | `skills/frontend-security-coder/SKILL.md` | 📄 File-only |
| `@cc-skill-security-review` | `skills/cc-skill-security-review/SKILL.md` | 📄 File-only |
| `@pci-compliance` | `skills/pci-compliance/SKILL.md` | 📄 File-only |

### 🐞 QA & Testing Pack
| Invocation | Path | Status |
|---|---|---|
| `@test-driven-development` | `skills/test-driven-development/SKILL.md` | 📄 File-only |
| `@systematic-debugging` | `skills/systematic-debugging/SKILL.md` | 📄 File-only |
| `@browser-automation` | `skills/browser-automation/SKILL.md` | 📄 File-only |
| `@e2e-testing-patterns` | `skills/e2e-testing-patterns/SKILL.md` | 📄 File-only |
| `@code-review-checklist` | `skills/code-review-checklist/SKILL.md` | 📄 File-only |
| `@test-fixing` | `skills/test-fixing/SKILL.md` | 📄 File-only |

### 🌧️ DevOps & Cloud Pack
| Invocation | Path | Status |
|---|---|---|
| `@docker-expert` | `skills/docker-expert/SKILL.md` | 📄 File-only |
| `@aws-serverless` | `skills/aws-serverless/SKILL.md` | 📄 File-only |
| `@kubernetes-architect` | `skills/kubernetes-architect/SKILL.md` | 📄 File-only |
| `@terraform-specialist` | `skills/terraform-specialist/SKILL.md` | 📄 File-only |
| `@deployment-procedures` | `skills/deployment-procedures/SKILL.md` | 📄 File-only |
| `@bash-linux` | `skills/bash-linux/SKILL.md` | 📄 File-only |

### 📊 Observability & Monitoring Pack
| Invocation | Path | Status |
|---|---|---|
| `@observability-engineer` | `skills/observability-engineer/SKILL.md` | 📄 File-only |
| `@distributed-tracing` | `skills/distributed-tracing/SKILL.md` | 📄 File-only |
| `@slo-implementation` | `skills/slo-implementation/SKILL.md` | 📄 File-only |
| `@incident-responder` | `skills/incident-responder/SKILL.md` | 📄 File-only |
| `@postmortem-writing` | `skills/postmortem-writing/SKILL.md` | 📄 File-only |
| `@performance-engineer` | `skills/performance-engineer/SKILL.md` | 📄 File-only |

### 🦄 Startup Founder Pack
| Invocation | Path | Status |
|---|---|---|
| `@product-manager-toolkit` | `skills/product-manager-toolkit/SKILL.md` | 📄 File-only |
| `@competitive-landscape` | `skills/competitive-landscape/SKILL.md` | 📄 File-only |
| `@launch-strategy` | `skills/launch-strategy/SKILL.md` | 📄 File-only |
| `@copywriting` | `skills/copywriting/SKILL.md` | 📄 File-only |
| `@stripe-integration` | `skills/stripe-integration/SKILL.md` | 📄 File-only |

### 📈 Marketing & Growth Pack
| Invocation | Path | Status |
|---|---|---|
| `@content-creator` | `skills/content-creator/SKILL.md` | 📄 File-only |
| `@seo-audit` | `skills/seo-audit/SKILL.md` | 📄 File-only |
| `@programmatic-seo` | `skills/programmatic-seo/SKILL.md` | 📄 File-only |
| `@analytics-tracking` | `skills/analytics-tracking/SKILL.md` | 📄 File-only |
| `@ab-test-setup` | `skills/ab-test-setup/SKILL.md` | 📄 File-only |
| `@email-sequence` | `skills/email-sequence/SKILL.md` | 📄 File-only |

### 🎮 Game Dev Pack
| Invocation | Path | Status |
|---|---|---|
| `@game-design` | `skills/game-development/game-design/SKILL.md` | 📁 Subfolder |
| `@2d-games` | `skills/game-development/2d-games/SKILL.md` | 📁 Subfolder |
| `@3d-games` | `skills/game-development/3d-games/SKILL.md` | 📁 Subfolder |
| `@unity-developer` | `skills/unity-developer/SKILL.md` | 📄 File-only |
| `@godot-gdscript-patterns` | `skills/godot-gdscript-patterns/SKILL.md` | 📄 File-only |
| `@algorithmic-art` | `skills/algorithmic-art/SKILL.md` | 📄 File-only |

### 🏗️ Architecture & Design Pack
| Invocation | Path | Status |
|---|---|---|
| `@senior-architect` | `skills/senior-architect/SKILL.md` | 📄 File-only |
| `@architecture-patterns` | `skills/architecture-patterns/SKILL.md` | 📄 File-only |
| `@microservices-patterns` | `skills/microservices-patterns/SKILL.md` | 📄 File-only |
| `@event-sourcing-architect` | `skills/event-sourcing-architect/SKILL.md` | 📄 File-only |
| `@architecture-decision-records` | `skills/architecture-decision-records/SKILL.md` | 🔵 Loadable |

### 🧱 DDD & Evented Architecture Pack
| Invocation | Path | Status |
|---|---|---|
| `@domain-driven-design` | `skills/domain-driven-design/SKILL.md` | 📄 File-only |
| `@ddd-strategic-design` | `skills/ddd-strategic-design/SKILL.md` | 📄 File-only |
| `@ddd-tactical-patterns` | `skills/ddd-tactical-patterns/SKILL.md` | 📄 File-only |
| `@cqrs-implementation` | `skills/cqrs-implementation/SKILL.md` | 📄 File-only |
| `@event-store-design` | `skills/event-store-design/SKILL.md` | 📄 File-only |
| `@saga-orchestration` | `skills/saga-orchestration/SKILL.md` | 📄 File-only |
| `@projection-patterns` | `skills/projection-patterns/SKILL.md` | 📄 File-only |

### 🛠️ OSS Maintainer Pack
| Invocation | Path | Status |
|---|---|---|
| `@commit` | `skills/commit/SKILL.md` | 📄 File-only |
| `@create-pr` | `skills/create-pr/SKILL.md` | 📄 File-only |
| `@changelog-automation` | `skills/changelog-automation/SKILL.md` | 📄 File-only |
| `@git-advanced-workflows` | `skills/git-advanced-workflows/SKILL.md` | 📄 File-only |
| `@documentation-templates` | `skills/documentation-templates/SKILL.md` | 📄 File-only |

### 🔗 Integrations Pack
| Invocation | Path | Status |
|---|---|---|
| `@stripe-integration` | `skills/stripe-integration/SKILL.md` | 📄 File-only |
| `@twilio-communications` | `skills/twilio-communications/SKILL.md` | 📄 File-only |
| `@hubspot-integration` | `skills/hubspot-integration/SKILL.md` | 📄 File-only |
| `@algolia-search` | `skills/algolia-search/SKILL.md` | 📄 File-only |
| `@analytics-tracking` | `skills/analytics-tracking/SKILL.md` | 📄 File-only |

### Standalone / Cross-Pack Skills
| Invocation | Path | Status |
|---|---|---|
| `@brainstorming` | `skills/brainstorming/SKILL.md` | 📄 File-only |
| `@mobile-developer` | `skills/mobile-developer/SKILL.md` | 📄 File-only |
| `@react-native-architecture` | `skills/react-native-architecture/SKILL.md` | 📄 File-only |
| `@app-store-optimization` | `skills/app-store-optimization/SKILL.md` | 📄 File-only |
| `@sql-pro` | `skills/sql-pro/SKILL.md` | 📄 File-only |
| `@postgres-best-practices` | `skills/postgres-best-practices/SKILL.md` | 📄 File-only |
| `@workflow-automation` | `skills/workflow-automation/SKILL.md` | 📄 File-only |

---

### ❌ Missing Skills & Substitutes

| Skill | Status | Substitute(s) |
|---|---|---|
| `@supabase` | ❌ Not in Antigravity repo | `skills/supabase-automation/SKILL.md` (193L) + `skills/nextjs-supabase-auth/SKILL.md` (219L) + `skills/postgres-patterns/SKILL.md` (ECC) |

---

### 🔑 Quick Reference by Path Pattern

| Pattern | Count | Example |
|---|---|---|
| `skills/<name>/SKILL.md` | 111 | `skills/react-patterns/SKILL.md` |
| `skills/game-development/<name>/SKILL.md` | 3 | `skills/game-development/game-design/SKILL.md` |
| Missing | 1 | `@supabase` |

**Total document skills: 114** — 111 on disk, 3 in subfolder, 1 missing with substitutes.
**Loadable via `skill` tool: 3** (`ui-ux-pro-max`, `python-patterns`, `architecture-decision-records`)
**All others: 111** — read manually from their SKILL.md file paths above.
